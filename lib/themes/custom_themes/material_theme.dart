...
class MaterialTheme {
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      primaryFixedDim: Color(0xff2f673f),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff667967),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff4e6150),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(0xff326941),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff124d27),
      onPrimaryContainer: Color(0xffffffff),
      ...
      inversePrimary: Color(0xffbdfbc6),
      primaryFixed: Color(0xff124d27),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff003516),
      onPrimaryFixedVariant: Color(0xffffffff),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      brightness: Brightness.dark,
      primary: Color(0xfff0ffee),
      surfaceTint: Color(0xff99d4a3),
      onPrimary: Color(0xff000000),
      primaryContainer: Color(0xff9dd9a7),
      onPrimaryContainer: Color(0xff000000),
      secondary: Color(0xfff0ffee),
      ...
      primaryFixedDim: Color(0xff9dd9a7),
      ...
      tertiaryFixed: Color(0xffc2eef9),
