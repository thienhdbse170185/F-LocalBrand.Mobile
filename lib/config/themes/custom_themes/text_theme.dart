...
class FTextTheme {
  ...
  static TextTheme light = TextTheme(
    titleLarge: const TextStyle(
        fontSize: 34, fontWeight: FontWeight.w800, fontFamily: "Nunito"),
    ...
    bodySmall: const TextStyle(
        fontSize: 10, fontWeight: FontWeight.w400, fontFamily: "Nunito"),
    ...
    labelSmall: const TextStyle(
        fontSize: 6, fontWeight: FontWeight.w200, fontFamily: "Nunito"),
    headlineLarge: const TextStyle(
        fontSize: 24, fontWeight: FontWeight.w700, fontFamily: "Nunito"),
    headlineMedium: const TextStyle(
        fontSize: 20, fontWeight: FontWeight.w700, fontFamily: "Nunito"),
    headlineSmall: const TextStyle(
        fontSize: 16, fontWeight: FontWeight.w700, fontFamily: "Nunito"),
  );
